...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File C:\Gemini\scripts\request-other-computer-info.ps1 -TargetLabel laptop -RepoPathHint "C:\Users\codym\Gemini-op"
```

## 2) Create a structured commit message automatically

```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File C:\Gemini\scripts\commit-with-communication.ps1 `
  -Type docs `
